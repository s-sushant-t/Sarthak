/*
  ...
  1. Security Updates
    - Add missing RLS policy for distributor_table_mapping table
    - Ensure proper authentication checks for all operations
    - Fix policies for dynamically created distributor tables

  2. Changes
    - Add INSERT policy for distributor_table_mapping table
    - Update existing policies to handle authentication properly
*/
